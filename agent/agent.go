...
func (a *Agent) reportMetrics() {
	...
	controlPlane := getEnv("CONTROL_PLANE_URL", "http://localhost:8080")
	...
	for range ticker.C {
		...
		req.Header.Set("X-Api-Key", "ak_MWE1ZjQ0NzctNWZjYi00NzJlLTkwMGItYTQ3MTMxNWNhNzhlOmMwYzhmM2JkODBkZTRkZTRhZTliMmNmYWY3NmY1OTky.IZctxGuX1XfHedhx3CsHTZvzOVsC1F4eW6hikn22_8k")
