...
func (r *fleetRepository) GetOverview(userID string) (*dto.FleetOverview, error) {
	overview := &dto.FleetOverview{
...
func (r *fleetRepository) GetEvents(userID string, limit int) ([]*dto.FleetEvent, error) {
	var events []*dto.FleetEvent
	query := `
...
func (r *fleetRepository) LogEvent(event *dto.FleetEvent) error {
	query := `
